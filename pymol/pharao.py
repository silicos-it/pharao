...
def __init__(self):
	self.menuBar.addmenuitem('Plugin', 'command',
							'Pharao visualization plugin', label = 'AlignIt...',
...
class PharaoPlugin:
	...
	def __init__(self, app):
		...
		print "+++ Silicos-it::Pharao Pymol Plugin (2012-2022) +++"
		self.phar = []
...
#------------------------------------------------------------------------------#
	...
	def runPharao(self):
		...
		pymol.cmd.save("/tmp/_tmp_Pharao.sdf", "sele", "0", "mol") 
		pymol.cmd.remove("hydrogens in " + id)
  
		#run Pharao
		os.system("/usr/local/bin/pharao -d /tmp/_tmp_Pharao.sdf -p /tmp/_tmp_Pharao.phar")
		...
		os.system("rm /tmp/_tmp_Pharao.sdf")
